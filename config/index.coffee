...
EXTERNAL_DOCS = /.*(python-sdk|node-sdk|cli|supervisor-api|update-locking|diagnostics|cli-masterclass|advanced-cli-masterclass|host-os-masterclass|services-masterclass|fleet-management-masterclass).*/
