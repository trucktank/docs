...
EXTERNAL_DOCS = /.*(python-sdk|node-sdk|balena-cli|supervisor-api|update-locking|diagnostics|cli-masterclass|advanced-cli|host-os-masterclass|services-masterclass|fleet-management-masterclass).*/
